...
- **Firebase App Check Enforcement**: Both public export callable functions enforce Firebase App Check (`enforceAppCheck: true`), preventing bot scraping, Denial-of-Service attacks, and automated bulk calendar extraction.
